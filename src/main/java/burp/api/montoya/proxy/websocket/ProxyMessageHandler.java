...
public interface ProxyMessageHandler {
   ...
   */
  TextMessageReceivedAction handleTextMessageReceived(
   ...
   * @return The {@link TextMessageReceivedAction} containing the required action and text message to be passed through.
   */
  TextMessageToBeSentAction handleTextMessageToBeSent(
      InterceptedTextMessage interceptedTextMessage);
   ...
   */
  BinaryMessageReceivedAction handleBinaryMessageReceived(
   ...
   * @return The {@link BinaryMessageReceivedAction} containing the required action and binary message to be passed through.
   */
  BinaryMessageToBeSentAction handleBinaryMessageToBeSent(
      InterceptedBinaryMessage interceptedBinaryMessage);
