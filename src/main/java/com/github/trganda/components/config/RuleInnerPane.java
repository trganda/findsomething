...
public class RuleInnerPane extends JPanel {
    ...
    private void setupComponents() {
        ...
        this.loadRulesWithGroup(Config.getInstance().getRules().getRulesWithGroup(GROUP_FINGERPRINT));
    }
        ...
        SwingWorker<List<Object[]>, Void> worker = new SwingWorker<>() {
            ...
            protected List<Object[]> doInBackground() {
                ...
                for (Rules.Rule rule : rules) {
                    list.add(new Object[]{rule.isEnabled(), rule.getName(), rule.getRegex(), rule.isSensitive()});
                }
                return list;
            }
    ...
    private static class RuleButtonsPane extends JPanel {
        private JButton add;
