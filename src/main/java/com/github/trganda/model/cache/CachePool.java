...
public class CachePool {
    ...
    private static final Cache<String, InterceptedResponse> httpMessageCache = Caffeine.newBuilder().maximumSize(MAX_SIZE).expireAfterWrite(EXPIRES_IN_HOURS, TimeUnit.HOURS).build();
    private static final Cache<String, List<RequestDataModel>> reqInfoCache = Caffeine.newBuilder().maximumSize(MAX_SIZE).build();
